...
`dotspacemacs/user-config' first."
  ;; dotspacemacs-themes '(light-soap)
  )
...
you should place your code here."
  (define-key evil-emacs-state-map (kbd "C-z") nil) ;;解除本身的切换模式，因为我只用emacs
  (xterm-mouse-mode -1)
  )
